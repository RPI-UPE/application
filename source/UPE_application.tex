...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def \UpeDeadline{12 noon on Wednesday, November 9th, 2016}
\def \UpeSemester{Fall 2016}
...
\begin{figure}[h!]
\centering
\includegraphics[width=6in]{UPE_logo}
\end{figure}


% Directions
Please fill out this form to be considered for admission to the New York Eta Chapter of Upsilon Pi Epsilon.
Please note that completion of this form does not guarantee your admission to the chapter and admittance is not determined by academic standing alone.
Return this form to the UPE mailbox in Lally Hall 207 by \UpeDeadline \ to have your application reviewed by the Membership Committee.
Please staple any and all included sheets to this one.
